...
function build(creep, flag, room) {
  let targetId = "5e4d20ecd289ae41c5c7286c";
  ...
  if (
    ...
    if (
      ...
      let t;
      if (!Memory.e36n31sites || Memory.e36n31sites) {
        Memory.e36n31sites = Game.rooms.E36N31.find(FIND_CONSTRUCTION_SITES, {
          filter: site => {
      ...
      let arr = [];
      _.forEach(Memory.e36n31sites, site => {
