...
function build(creep, flag, room) {
  let targetId = "5bbcaeeb9099fc012e639c4a";
  ...
  if (rmName !== room) {
    return smartMove(creep, flag, 1, false, null, 10, 200, 4);
  }
  ...
  if (
    ...
    if (
      ...
      if (!Memory.e36n32sites || Memory.e36n32sites) {
        Memory.e36n32sites = Game.rooms.E34N32.find(FIND_CONSTRUCTION_SITES, {
          filter: site => {
    ...
    if (creep.pos.inRangeTo(target, 3)) {
      ...
      retval = smartMove(creep, target, 3, false, "#ffff0f", null, 100, 1);
