...
const getEnergyNorth = require("./getEnergy.action.getEnergy");
const getEnergyEast = require("./getEnergy.action.getEnergy");
const getEnergyEE = require("./action.getEnergyEEast");
const getEnergyWest = require("./getEnergy.action.getEnergy");
