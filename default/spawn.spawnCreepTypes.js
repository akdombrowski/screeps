...
function spawnCreepTypes(enAvail, spawns) {
  ...
  //  #     #   #   #    #   #
  //   #####     ###      ###
  if (enAvail >= 300 && !invaderId && creepsHome.length < 22) {
    let name = "h" + t;
    let chosenRole = "h";
    let direction = "home";
    let sourceId = Memory.source2;
    ...
    if (upControllers.length < 2) {
      ...
      logConditionPassedForSpawnCreep("creepsHome", creepsHome, 22);
      name = "upC" + t;
      chosenRole = "upC";
      group = "upControllers";
  ...
  //   if (harvesters.length < 8 && creepshome.length < 12) {
  //     logConditionPassedForSpawnCreep("harvesters", harvesters, 8);
  //     logConditionPassedForSpawnCreep("creepshome", creepshome, 12);
  //     name = "h" + t;
  //     chosenRole = "h";
  //     direction = "home";
  //     creepshome.push(name);
