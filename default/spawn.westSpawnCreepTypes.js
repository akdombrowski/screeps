...
function spawnCreepTypes(enAvail, spawns) {
  ...
  if (enAvail >= 300 && !wAttacker) {
    ...
    } else if (harvestersNorthwest.length < 2) {
      logConditionPassedForSpawnCreep(
        "harvestersNorthwest",
        harvestersNorthwest,
        2
    ...
    if (retval !== -16) {
      console.log("spawningW " + name + "_" + cost + " " + retval);
      console.log("energy: 300  parts: " + parts);
    }
    if (retval === OK || retval === ERR_BUSY) {
      return retval;
  ...
  if (enAvail >= 550 && !invader) {
    ...
    } else if (harvestersNorthwest.length < 6) {
      logConditionPassedForSpawnCreep(
        "harvestersNorthwest",
        harvestersNorthwest,
        6
  ...
  if (enAvail >= 800) {
    ...
    } else if (harvestersNorthwest.length < 7) {
      logConditionPassedForSpawnCreep(
        "harvestersNorthwest",
        harvestersNorthwest,
        7
